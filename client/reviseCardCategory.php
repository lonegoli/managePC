<?php
include("quote.php");
$cardCategoryID=$_POST['cardCategoryID'];
...
$sql=sprintf("update cardCategory set gradeID=%d,remark=\"%s\",rewardPointsYn=%d,rewardPoints=%f,feeChargingCardYN=%d,feeChargingCard=%f,restrain=%d,startTime=\"%s\",endTime=\"%s\" where cardCategoryID=%d",$disCountCategory,$remark,$rewardPoints,0.00,$feeChargCard,0.00,$timeRestrain,$startTime,$endTime,$cardCategoryID);
